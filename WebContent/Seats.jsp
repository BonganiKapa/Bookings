...
<%@ page import="airline.bookings.controller.Bookings" %>
            ...
            <div id="page-inner">
                ...
                <a href="viewFlightInstances.jsp" class="btn btn-danger square-btn-adjust">Get List of flights for a passenger</a>
                    ...
                    <div class="panel panel-default">
                        ...
                        <h4>Fly anywhere in South Africa starting from R400</h4>

                        <h4>Earn 10 000 Kilometer points for each flight with Star Light Airlines</h4>
